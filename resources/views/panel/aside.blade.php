@section('aside')
        <div class="list-group">
            ...
            <a href="#" class="list-group-item list-group-item-action {{ Route::is('panel_prod_list') ? 'active' : null }} @if (!Auth::user()->hasPermission('manage-products')) disabled @endif">Товары</a>
